...
subject_list = '/home/ubuntu/abide/preprocessing/settings/CPAC_subject_list_nfb_3_37.yml'
...
bucket_prefix = 'data/Projects/RocklandSample'
bucket_upload_prefix = 'data/Projects/RocklandSample/Outputs/cpac'
