#' # ABIDE: Spatial Functional Data Quality Metrics

#' Here we plot all the anatomical QA measures. The code for this can be found 
#' at https://github.com/preprocessed-connectomes-project/abide/blob/master/plot/qa_plot_func_spatial.R
...
qa.measures <- c("func_efc", "func_fber", "func_fwhm", "func_gsr")
qa.descs    <- list(
  func_efc  = "Entropy Focus Criteria", 
  func_fber = "Foreground to Background Energy Ratio", 
  func_fwhm = "FWHM in mm", 
